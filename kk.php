...
if (isset($_REQUEST['FirstName'], $_REQUEST['email'], $_REQUEST['password'])){
    ...
    $query = "INSERT into `client` (FirstName, email, password)
              VALUES ('$FirstName', '$email', '".hash('sha256', $password)."')";
